...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("t2.data2 : " + t2.getData1());
		System.out.println("t2.data2 : " + t2.getData2());
		System.out.println("t2.data2 : " + t2.getData3());
		System.out.println("t2.data2 : " + t2.getData4());
		System.out.println("================================================================================");

		TestBean3 t3 = ctx.getBean("tb3", TestBean3.class);
